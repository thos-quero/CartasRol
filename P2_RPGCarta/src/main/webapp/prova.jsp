...
<meta charset="UTF-8">
<title>Introducció Valors</title>
</head>
<body id="body_p1">

	<form method="post" action="procesar.jsp" id="form">
	<div id="upper-f">
		<label style="color:gold;">Nom de la carta: </label>
		<input type="text" name="nom" class="btns">
		<br>
		<label style="color:gold;">Usuari de la db: </label>
		<input type="text" name="userbd" class="btns">
		<label style="color:gold;">Contrasenya: </label>
		<input type="password" name="passwdbd" class="btns">
	</div>
		<%!public int getValue() {
		int value = 0;
		int[] daus = { 0, 0, 0, 0 };
